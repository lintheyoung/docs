---
title: '从会话创建陷阱'
openapi: 'POST /v1/setup-sessions/{id}/create-trap'
---

<RequestExample>
```bash cURL
curl https://api.rattrap.ai/v1/setup-sessions/ss_1Qy8u8CZ7aQp98Xb5WJtR3/create-trap \
...
const res = await fetch(
  `https://api.rattrap.ai/v1/setup-sessions/${sessionId}/create-trap`,
  {
    method: "POST",
    headers: {
