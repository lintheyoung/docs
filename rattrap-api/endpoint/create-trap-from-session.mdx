...
<RequestExample>
```bash cURL
curl "https://lrsppxarhxvxcflougbp.supabase.co/functions/v1/create-trap-from-session?session_id=ss_1Qy8u8CZ7aQp98Xb5WJtR3" \
  -X POST \
...
const res = await fetch(
  `https://lrsppxarhxvxcflougbp.supabase.co/functions/v1/create-trap-from-session?session_id=${sessionId}`,
  {
    method: "POST",
    headers: {
