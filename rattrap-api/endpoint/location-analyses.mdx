---
title: '分析放置位置'
openapi: 'POST /v1/location-analyses'
---

<RequestExample>
```bash cURL
curl https://lrsppxarhxvxcflougbp.supabase.co/functions/v1/location-analyses \
...
```javascript Node.js
const res = await fetch("https://lrsppxarhxvxcflougbp.supabase.co/functions/v1/location-analyses", {
  method: "POST",
  headers: {
