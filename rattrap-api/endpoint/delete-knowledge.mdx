...
<RequestExample>
```bash cURL
curl -X DELETE https://vwinvkxxheuexvpvzibt.supabase.co/functions/v1/knowledge-base/kb_1a2b3c4d5e6f7g8h \
...
```bash
curl -X PATCH https://vwinvkxxheuexvpvzibt.supabase.co/functions/v1/knowledge-base/kb_1a2b3c4d5e6f7g8h \
